...
@"{var $title = Title inside template}
Lorem ipsum";
...
Lorem ipsum
        ...
        private readonly string _testTemplateData =
@"{var $name = Alice}
{var $lastName = ""Wonderland""}
Lorem ipsum
{var $lorem = 'ipsum'}
{var $space = ' '}
{var $space2 = "" ""}";
        ...
        [Fact]
        public void ShouldLoadTemplateData()
        {
            var loader = Substitute.For<ITemplateLoader>();
            loader.GetContent("test").Returns(this._testTemplateData);
            ...
            formatter.FormatTemplate("test", data);
            Assert.Equal(data["name"], "Alice");
            Assert.Equal(data["lastName"], "Wonderland");
            Assert.Equal(data["lorem"], "ipsum");
            Assert.Equal(data["space"], " ");
            Assert.Equal(data["space2"], " ");
        }
